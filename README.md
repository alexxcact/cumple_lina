...
Una dedicatoria de Karolina para Lina. La página incluye una carta, fotos de la carpeta `images` y una pequeña animación de celebración.

## Vista local

Abre `index.html` en un navegador, o sirve esta carpeta con un servidor estático. No necesita instalación ni dependencias externas.
